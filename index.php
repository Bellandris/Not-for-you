...
while($myrow = mysql_fetch_array($result)){
	...
	echo 	
		"
											<div class=\"news-bg\">
				<div class=\"news-title\">".$myrow['nazva']."</div>
				<div class=\"news-info\">".$myrow['data']."</div>
				<div class=\"news-image-bg\"><div id=\"img_news_otstup\"><img style=\"width:158px;height:118px;border:2px solid #6e2c77;\" src=\"templates/main/images/image1.jpg\" alt=\"\"></div></div>
				<br>
				<div class=\"news\">
					
".$myrow['textmini']."
<a href=\"/fullnews.php?id=".$myrow['id']."\">&nbspПодробнее...</a>
				</div>
